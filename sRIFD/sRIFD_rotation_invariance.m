...
pt1=[m1_points.Location];
pt2=[m2_points.Location];

% % Plot the keypoints on m1 image using imagesc
% figure;
% imshow(m1); % 使用imagesc显示图像
% hold on;
% plot(m1_points.Location(:,1), m1_points.Location(:,2), 'ro', 'MarkerFaceColor', 'none', 'MarkerSize', 5); % 绘制红色小圆圈作为关键点
% title('Keypoints on m1 Image');
% hold off;
